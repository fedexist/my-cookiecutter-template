...
project = 'aa-pypackage'
copyright = '2020, Federico D\'Ambrosio'
...
htmlhelp_basename = 'aa-pypackagedoc'
...
latex_documents = [
    (master_doc, 'aa-pypackage.tex', 'aa-pypackage Documentation',
     'Federico D\'Ambrosio', 'manual'),
]
...
man_pages = [
    (master_doc, 'aa-pypackage', 'aa-pypackage Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'aa-pypackage', 'aa-pypackage Documentation',
     author, 'aa-pypackage', 'One line description of project.',
     'Miscellaneous'),
]
